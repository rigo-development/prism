...
<template>
  <div class="h-full flex flex-col font-mono" :class="{ 'opacity-80': readonly }">
    <label class="text-xs md:text-sm text-slate-400 mb-2 flex justify-between items-center">
    ...
    <textarea
      v-model="code"
      :readonly="readonly"
      class="flex-1 w-full bg-slate-800 text-slate-100 p-3 md:p-4 rounded-lg focus:outline-none font-mono text-xs md:text-sm leading-5 md:leading-6 resize-none transition-all custom-scrollbar"
